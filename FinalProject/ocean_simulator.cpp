...
OceanSimulator::OceanSimulator(OceanParameter& params, ID3D11Device* pd3dDevice)
{
    ...
    CompileShaderFromFile(L"/shaders/ocean_simulator_cs.hlsl", "UpdateSpectrumCS", "cs_4_0", &pBlobUpdateSpectrumCS);
    ...
    CompileShaderFromFile(L"/shaders/ocean_simulator_vs_ps.hlsl", "QuadVS", "vs_4_0", &pBlobQuadVS);
    CompileShaderFromFile(L"/shaders/ocean_simulator_vs_ps.hlsl", "UpdateDisplacementPS", "ps_4_0", &pBlobUpdateDisplacementPS);
    CompileShaderFromFile(L"/shaders/ocean_simulator_vs_ps.hlsl", "GenGradientFoldingPS", "ps_4_0", &pBlobGenGradientFoldingPS);
	assert(pBlobQuadVS);
...
void OceanSimulator::initHeightMap(OceanParameter& params, XMFLOAT2* out_h0, float* out_omega)
{
	...
	XMFLOAT2 wind_dir;
	XMVECTOR resu = XMVector2Normalize(XMLoadFloat2(&params.wind_dir));
	XMStoreFloat2(&wind_dir, resu);
